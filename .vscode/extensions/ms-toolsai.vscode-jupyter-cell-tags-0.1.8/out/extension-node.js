...
function addCellTag(cell, tags) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const oldTags = (_c = (_b = (_a = cell.metadata.custom) === null || _a === void 0 ? void 0 : _a.metadata) === null || _b === void 0 ? void 0 : _b.tags) !== null && _c !== void 0 ? _c : [];
        const newTags = [];
        ...
        const nbEdit = vscode.NotebookEdit.updateCellMetadata(cell.index, Object.assign({}, cellMetadata));
...
class CellTagStatusBarProvider {
    provideCellStatusBarItems(cell, token) {
        var _a, _b, _c;
        const items = [];
        (_c = (_b = (_a = cell.metadata.custom) === null || _a === void 0 ? void 0 : _a.metadata) === null || _b === void 0 ? void 0 : _b.tags) === null || _c === void 0 ? void 0 : _c.forEach((tag) => {
            items.push({
                text: '$(close) ' + tag,
                tooltip: tag,
                command: {
...
function register(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('jupyter-cell-tags.removeTag', (cell, tag) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (tags) {
            ...
            // create workspace edit to update tag
            const edit = new vscode.WorkspaceEdit();
            const nbEdit = vscode.NotebookEdit.updateCellMetadata(activeCell.index, Object.assign({}, activeCell.metadata));
...
// Licensed under the MIT License.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getCellTags = void 0;
function getCellTags(cell) {
    var _a, _b, _c;
    return (_c = (_b = (_a = cell.metadata.custom) === null || _a === void 0 ? void 0 : _a.metadata) === null || _b === void 0 ? void 0 : _b.tags) !== null && _c !== void 0 ? _c : [];
}
...
const cellTagsTreeDataProvider_1 = __webpack_require__(4);
